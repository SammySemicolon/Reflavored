...
import static com.sammy.reflavored.ReflavoredHelper.prefix;
...
public class ModBlockStateProvider extends net.minecraftforge.client.model.generators.BlockStateProvider
{
    ...
    protected void registerStatesAndModels()
    {
        ...
        takeAll(blocks, b -> b.get() instanceof ReflavoredWallSignBlock).forEach(this::signBlock);
        takeAll(blocks, b -> b.get() instanceof ReflavoredStandingSignBlock).forEach(this::signBlock);
