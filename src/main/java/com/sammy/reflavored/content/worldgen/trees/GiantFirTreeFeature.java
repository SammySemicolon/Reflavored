...
public class GiantFirTreeFeature extends Feature<NoFeatureConfig>
{
    public GiantFirTreeFeature()
    {
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config)
    {
        ...
        makeLeafBlob(leavesFiller, ReflavoredBlocks.FIR_LEAVES.get(), pos.up(12+extraHeight));
    ...
    public static void makeLeafBlob(WorldFiller filler, Block block, BlockPos pos)
    {
        ...
        makeDiamondLeafSlice(filler, block, pos.up(2), 3);
