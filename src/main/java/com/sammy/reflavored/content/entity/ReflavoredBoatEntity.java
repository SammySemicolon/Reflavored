package com.sammy.reflavored.content.entity;
...
public class ReflavoredBoatEntity extends BoatEntity
{
    private final RegistryObject<Item> boatItem;
    private final RegistryObject<Item> plankItem;
    public ReflavoredBoatEntity(EntityType<? extends ReflavoredBoatEntity> type, World world, RegistryObject<Item> boatItem, RegistryObject<Item> plankItem)
    {
        super(type, world);
