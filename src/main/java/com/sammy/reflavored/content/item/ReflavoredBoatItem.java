package com.sammy.reflavored.content.item;
...
public class ReflavoredBoatItem extends Item
{
    private static final Predicate<Entity> field_219989_a = EntityPredicates.NOT_SPECTATING.and(Entity::canBeCollidedWith);
    private final RegistryObject<EntityType<ReflavoredBoatEntity>> boat;
    public ReflavoredBoatItem(Properties properties, RegistryObject<EntityType<ReflavoredBoatEntity>> boat)
    {
        super(properties);
        this.boat = boat;
    }
